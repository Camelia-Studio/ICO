...
<?php $renderer->renderLayout('layout/header', ['pageTitle' => 'Administration - ICO']); ?>
    ...
    <div class="admin-content">
        ...
        <div class="admin-menu">
            ...
            <a href="liens-sociaux.php" class="admin-menu-item">
                <div class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="menu-content">
                    <h2>Liens sociaux</h2>
                    <p>Gérez les liens vers vos réseaux sociaux affichés dans le pied de page.</p>
                </div>
            </a>

            <a href="pages-info.php" class="admin-menu-item">
                <div class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="menu-content">
                    <h2>Pages "En savoir plus"</h2>
                    <p>Créez et gérez les pages de contenu accessibles depuis la galerie.</p>
                </div>
            </a>
